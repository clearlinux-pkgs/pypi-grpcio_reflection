...
Version  : 1.51.0
Release  : 35
URL      : https://files.pythonhosted.org/packages/76/16/527faa9612444f0a8ed4d182a7bb31b1caa697fb6bfac9ee3185cf992300/grpcio-reflection-1.51.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/76/16/527faa9612444f0a8ed4d182a7bb31b1caa697fb6bfac9ee3185cf992300/grpcio-reflection-1.51.0.tar.gz
...
%prep
%setup -q -n grpcio-reflection-1.51.0
cd %{_builddir}/grpcio-reflection-1.51.0
pushd ..
cp -a grpcio-reflection-1.51.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1669133060
