...
Version  : 1.70.0
Release  : 74
URL      : https://files.pythonhosted.org/packages/42/98/f76681980ec7e9813e010d2778f4109816650760f6839661ae378286b3b5/grpcio_reflection-1.70.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/42/98/f76681980ec7e9813e010d2778f4109816650760f6839661ae378286b3b5/grpcio_reflection-1.70.0.tar.gz
...
%prep
%setup -q -n grpcio_reflection-1.70.0
cd %{_builddir}/grpcio_reflection-1.70.0
pushd ..
cp -a grpcio_reflection-1.70.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1737732265
