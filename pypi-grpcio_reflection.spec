...
Version  : 1.60.0
Release  : 53
URL      : https://files.pythonhosted.org/packages/33/3a/e257225b8fd9f05d2af3e363459f0d074ca684438667892ea3215e2162ca/grpcio-reflection-1.60.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/33/3a/e257225b8fd9f05d2af3e363459f0d074ca684438667892ea3215e2162ca/grpcio-reflection-1.60.0.tar.gz
...
%prep
%setup -q -n grpcio-reflection-1.60.0
cd %{_builddir}/grpcio-reflection-1.60.0
pushd ..
cp -a grpcio-reflection-1.60.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1702926096
