...
Version  : 1.49.1
Release  : 31
URL      : https://files.pythonhosted.org/packages/a0/7c/b6e7a7c9225d7c1d7f94ff4c9466f52445309afcdbb0cb227b7803fde298/grpcio-reflection-1.49.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/a0/7c/b6e7a7c9225d7c1d7f94ff4c9466f52445309afcdbb0cb227b7803fde298/grpcio-reflection-1.49.1.tar.gz
...
%prep
%setup -q -n grpcio-reflection-1.49.1
cd %{_builddir}/grpcio-reflection-1.49.1
pushd ..
cp -a grpcio-reflection-1.49.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1663862022
