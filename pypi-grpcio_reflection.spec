...
Version  : 1.46.0
Release  : 20
URL      : https://files.pythonhosted.org/packages/04/38/362d46828c09d77414325c229eb017422128b89b794d80096492485ff0dd/grpcio-reflection-1.46.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/04/38/362d46828c09d77414325c229eb017422128b89b794d80096492485ff0dd/grpcio-reflection-1.46.0.tar.gz
...
%prep
%setup -q -n grpcio-reflection-1.46.0
cd %{_builddir}/grpcio-reflection-1.46.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1651678314
...
cp %{_builddir}/grpcio-reflection-1.46.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-grpcio_reflection/34ac89724cb7e3fb36bcfe93efabfd012c569a0e
