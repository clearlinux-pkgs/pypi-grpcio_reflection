...
Version  : 1.59.2
Release  : 50
URL      : https://files.pythonhosted.org/packages/9a/16/04c98ad4ce3b317c985fefb7acadbbbeb800a23a91f5e1216e125828c58d/grpcio-reflection-1.59.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/9a/16/04c98ad4ce3b317c985fefb7acadbbbeb800a23a91f5e1216e125828c58d/grpcio-reflection-1.59.2.tar.gz
...
%prep
%setup -q -n grpcio-reflection-1.59.2
cd %{_builddir}/grpcio-reflection-1.59.2
pushd ..
cp -a grpcio-reflection-1.59.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1698766086
