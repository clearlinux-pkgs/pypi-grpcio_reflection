...
Version  : 1.49.0
Release  : 30
URL      : https://files.pythonhosted.org/packages/97/6a/92fd7aa8c5cac07922be9865a10a80d04ba317b986397f78dd3a41b4825e/grpcio-reflection-1.49.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/97/6a/92fd7aa8c5cac07922be9865a10a80d04ba317b986397f78dd3a41b4825e/grpcio-reflection-1.49.0.tar.gz
...
%prep
%setup -q -n grpcio-reflection-1.49.0
cd %{_builddir}/grpcio-reflection-1.49.0
pushd ..
cp -a grpcio-reflection-1.49.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1663343218
