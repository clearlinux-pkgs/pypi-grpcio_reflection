...
Version  : 1.65.1
Release  : 61
URL      : https://files.pythonhosted.org/packages/8a/d1/07125fe229ab542569523f3a9014da4583df8d3cd7a8c0cf9b429dde7ab9/grpcio_reflection-1.65.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/8a/d1/07125fe229ab542569523f3a9014da4583df8d3cd7a8c0cf9b429dde7ab9/grpcio_reflection-1.65.1.tar.gz
...
%prep
%setup -q -n grpcio_reflection-1.65.1
cd %{_builddir}/grpcio_reflection-1.65.1
pushd ..
cp -a grpcio_reflection-1.65.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721317163
