...
Version  : 1.62.1
Release  : 56
URL      : https://files.pythonhosted.org/packages/fa/14/75ddfa0e3321786833f388909326461377ae100a7222e2df1b133c87cb7e/grpcio-reflection-1.62.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/fa/14/75ddfa0e3321786833f388909326461377ae100a7222e2df1b133c87cb7e/grpcio-reflection-1.62.1.tar.gz
...
%prep
%setup -q -n grpcio-reflection-1.62.1
cd %{_builddir}/grpcio-reflection-1.62.1
pushd ..
cp -a grpcio-reflection-1.62.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710171975
