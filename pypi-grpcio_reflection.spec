...
Version  : 1.51.3
Release  : 39
URL      : https://files.pythonhosted.org/packages/b3/55/4b2f66e22a6dc0d2461b33b3810854a9589cb4245517440071be82183324/grpcio-reflection-1.51.3.tar.gz
Source0  : https://files.pythonhosted.org/packages/b3/55/4b2f66e22a6dc0d2461b33b3810854a9589cb4245517440071be82183324/grpcio-reflection-1.51.3.tar.gz
...
%prep
%setup -q -n grpcio-reflection-1.51.3
cd %{_builddir}/grpcio-reflection-1.51.3
pushd ..
cp -a grpcio-reflection-1.51.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677082306
