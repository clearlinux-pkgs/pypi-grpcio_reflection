...
Version  : 1.48.1
Release  : 29
URL      : https://files.pythonhosted.org/packages/00/de/af4fb1d3028a158d085b1a9847d38c1b0abd2c2a22c43adb59beafee8405/grpcio-reflection-1.48.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/00/de/af4fb1d3028a158d085b1a9847d38c1b0abd2c2a22c43adb59beafee8405/grpcio-reflection-1.48.1.tar.gz
...
%prep
%setup -q -n grpcio-reflection-1.48.1
cd %{_builddir}/grpcio-reflection-1.48.1
pushd ..
cp -a grpcio-reflection-1.48.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662077591
