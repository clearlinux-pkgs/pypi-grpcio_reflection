...
Version  : 1.69.0
Release  : 73
URL      : https://files.pythonhosted.org/packages/bd/88/064538adae2e526f4626ad57f53a99fca5ae5013e627214093ef1d47cc35/grpcio_reflection-1.69.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/bd/88/064538adae2e526f4626ad57f53a99fca5ae5013e627214093ef1d47cc35/grpcio_reflection-1.69.0.tar.gz
...
%prep
%setup -q -n grpcio_reflection-1.69.0
cd %{_builddir}/grpcio_reflection-1.69.0
pushd ..
cp -a grpcio_reflection-1.69.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736178797
